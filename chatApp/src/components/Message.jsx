...
const Message = ({ message }) => {
  ...
  return (
    <div
      ...
      } ${message.senderId === 'capychat-ai' ? 'ai' : ''}`}
    >
      <div className='messageInfo'>
        {message.senderId === 'capychat-ai' ? (
          <img src={CapyLogo} alt='AI avatar' className='avatar' />
        ) : (
          <Image
            urlEndpoint={IMAGEKIT_CONFIG.urlEndpoint}
            src={extractFirebasePath(
      ...
      {enlargedImage && (
        <div className='imageModal' onClick={() => setEnlargedImage(null)}>
